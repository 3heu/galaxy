...
producer=aprods3
pubkey=GAL7Dg55w6aMc1drsQzGWyKz6mfAgQ744nad8cY8cZ3NEGXk97XVG
prikey=5JTF8EmWDVKd7cDfJxny7e154UmjwkL91RnMdson9ZqoFBX4CsC
...
${nodgal} \
    ...
    --http-server-address=10.0.0.5:8004 \
    --p2p-listen-endpoint=10.0.0.5:9004 \
    --p2p-server-address=10.0.0.5:9004\
