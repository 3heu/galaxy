...
producer=sprods3
pubkey=GAL5JP2xyiZ4J8JuVprYr7VV5d7V3GhozusDUqJgJSW1sMZkmMMtS
prikey=5JxDmiJfiAUjDtAfu5WRLyoTidmUQytFdWWFPLhQJkJH1xSR85T
...
${nodgal} \
    ...
    --http-server-address=10.0.0.10:8009 \
    --p2p-listen-endpoint=10.0.0.10:9009 \
    --p2p-server-address=10.0.0.10:9009 \
