...
producer=aprods5
pubkey=GAL84BLRbGbFahNJEpnnJHYCoW9QPbQEk2iHsHGGS6qcVUq9HhutG
prikey=5KAVVPzPZnbAx8dHz6UWVPFDVFtU1P5ncUzwHGQFuTxnEbdHJL4
...
${nodgal} \
    ...
    --http-server-address=10.0.0.7:8006 \
    --p2p-listen-endpoint=10.0.0.7:9006 \
    --p2p-server-address=10.0.0.7:9006 \
