...
producer=aprods1
pubkey=GAL6BZxjPemrsBRmfCDHf3afvJ4t7JDcNE3UXMudPsE4ezCMUJsWk
prikey=5KexNTtncryJnof5SsKUH2nE9BYdCemsgiNkQQxJnjSG6HaUYVR
...
${nodgal} \
    ...
    --http-server-address=10.0.0.3:8002 \
    --p2p-listen-endpoint=10.0.0.3:9002 \
    --p2p-server-address=10.0.0.3:9002 \
