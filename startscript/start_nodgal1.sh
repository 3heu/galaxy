...
producer=galaxy
pubkey=GAL6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
...
${nodgal} \
    ...
    --http-server-address=10.0.0.2:8001 \
    --p2p-listen-endpoint=10.0.0.2:9001 \
    --p2p-server-address=10.0.0.2:9001 \
