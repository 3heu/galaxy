...
producer=sprods1
pubkey=GAL6YbMDQkoVv6nPEQ4hLiVT9PT2XYKRrkCLq6g9rxhdwbm9D9swp
prikey=5KaZgdzBV4STUWkRzWsAFAFDuXQvBCPW2bkGxj4bkx5cd2uEbJw
...
${nodgal} \
    ...
    --http-server-address=10.0.0.8:8007 \
    --p2p-listen-endpoint=10.0.0.8:9007 \
    --p2p-server-address=10.0.0.8:9007 \
