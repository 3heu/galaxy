...
producer=aprods2
pubkey=GAL89Uj4bAVRDwP99VmjcL2Us6TebzsJRTfvbTNo4bmEioMwC2FTV
prikey=5JbFfhtjUkL1RsZsW1MXxzG21pYSJwVQR6UFbvJAEtjwtGtgiAV
...
${nodgal} \
    ...
    --http-server-address=10.0.0.4:8003 \
    --p2p-listen-endpoint=10.0.0.4:9003 \
    --p2p-server-address=10.0.0.4:9003\
