...
producer=sprods2
pubkey=GAL5KT2TZDvobRot9GvUCM8VtBoKyDoE2LpihUdJUSC2hnq7fPuj3
prikey=5JkFRF4eCbYTbQ74K8MDpqZiexiBEuyPvhNkg7vS3f9VDXXFzvj
...
${nodgal} \
    ...
    --http-server-address=10.0.0.9:8008 \
    --p2p-listen-endpoint=10.0.0.9:9008 \
    --p2p-server-address=10.0.0.9:9008 \
