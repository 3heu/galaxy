...
producer=sprods4
pubkey=GAL6xs6kBVLpDfAn97yY9m3j5bZctousUHcgwijA6yD2UeLWjD1dY
prikey=5Jwn7tQWwubHj3vNvAhn3dQH7zohhvpT9V81jbBsFVr2PaPCvwb
...
${nodgal} \
    ...
    --http-server-address=10.0.0.11:8010 \
    --p2p-listen-endpoint=10.0.0.11:9010 \
    --p2p-server-address=10.0.0.11:9010 \
    --p2p-peer-address 10.0.0.2:9001 \
    --p2p-peer-address 10.0.0.3:9002 \
    --p2p-peer-address 10.0.0.4:9003 \
    --p2p-peer-address 10.0.0.5:9004 \
    --p2p-peer-address 10.0.0.6:9005 \
    --p2p-peer-address 10.0.0.7:9006 \
    --p2p-peer-address 10.0.0.8:9007 \
    --p2p-peer-address 10.0.0.9:9008 \
    --p2p-peer-address 10.0.0.10:9009 \
